...
root.configure(width=1500,height=600,bg="#EDF1D6")
var=-1
...
def clearitem():
    ...
    entry5.delete(0, END)
#fn1353
label0= Label(root,text="PHARMACY MANAGEMENT SYSTEM ",bg="#9DC08B",fg="white",font=("Times", 30))
label1=Label(root,text="ENTER ITEM NAME",bg="#609966",relief="ridge",fg="white",font=("Times", 12),width=25)
entry1=Entry(root , font=("Times", 12))
label2=Label(root, text="ENTER ITEM PRICE",bd="2",relief="ridge",height="1",bg="#609966",fg="white", font=("Times", 12),width=25)
entry2= Entry(root, font=("Times", 12))
label3=Label(root, text="ENTER ITEM QUANTITY",bd="2",relief="ridge",bg="#609966",fg="white", font=("Times", 12),width=25)
entry3= Entry(root, font=("Times", 12))
label4=Label(root, text="ENTER ITEM CATEGORY",bd="2",relief="ridge",bg="#609966",fg="white", font=("Times", 12),width=25)
entry4= Entry(root, font=("Times", 12))
label5=Label(root, text="ENTER ITEM DISCOUNT",bg="#609966",relief="ridge",fg="white", font=("Times", 12),width=25)
